...
class ControllerAdmin {
    ...
    public static function isAdmin() { // MIGRATION OK
    ...
    // Charge l'index de l'administration MIGRATION OK
    ...
    // DETAILS ----------------------------------------------- //---FINISHED CRUD---// MIGRATION OK
    ...
    // PRESTATIONS ----------------------------------------------- //---FINISHED CRUD---// MIGRATION OK
    ...
    // RESERVATION ------------------------------------------------ //---IN PROGRESS---// MIGRATION OK
