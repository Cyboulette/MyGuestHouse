...
echo "<h1 class='page-header'>Ajout d'une reservation</h1>";
echo "
		<form method='post' action='index.php?controller=admin&action=addedReservation' enctype='multipart/form-data'>
