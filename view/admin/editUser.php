		...
		<div class="row">
			...
			<form class="form-horizontal col-xs-offset-1" method='post' action='index.php?controller=adminUtilisateurs&action=edited&idUtilisateur=<?=$id?>' enctype='multipart/form-data'>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<input required class='form-control' type='email' name='email' id='id_email' value=<?=$email?>>
					</div>
				</div>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<input required class='form-control' type='text' value=<?=$prenom?> name='prenom' id='id_prenom'>
					</div>
				</div>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<input required class='form-control' type='text' value=<?=$nom?> name='nom' id='id_nom'>
					</div>
				</div>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<select required class='form-control' name='rang' id='id_rang'>
		...
		<div class="row">
			...
			<form class="form-horizontal col-xs-offset-1" method='post' action='?controller=adminUtilisateurs&action=changePassword&idUtilisateur=<?=$id?>' enctype='multipart/form-data'>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<input required class='form-control' type='password' name='ancienMDP' id='id_ancienMDP' placeholder='Ancien mot de passe'>
					</div>
				</div>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<input required class='form-control' type='password' name='nouveauMDP' id='id_nouveauMDP' placeholder='Nouveau mot de passe'>
					</div>
				</div>
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
						<input required class='form-control' type='password' name='nouveauMDPbis' id='id_nouveauMDPbis' placeholder='Validation du mot de passe'>
					</div>
				</div>
				...
				<div class='form-group'>
					<div class="col-sm-offset-2 col-sm-3">
						<input required type='submit' class='btn btn-s btn-success btn-block' value='Modifier'>
						<?php echo "<input required type='hidden' value='{$id}' name='id'>"; ?>
					</div>
				</div>
			</form>
		</div>
