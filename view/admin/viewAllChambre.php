<div class="col-xs-12">
    <?php if (isset($tab_v) && !empty($tab_v)) {
        echo '<h1 class="page-header">Chambres</h1>';
        ...
        echo '<div class="alert alert-danger">'."Il n'y a aucune chambres pour l'instant <br> <a href='#'>Commencer à vous  développer</a>".'</div>';
    }
    ?>
</div>