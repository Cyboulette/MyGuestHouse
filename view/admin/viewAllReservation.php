...
<div>
    ...
    <div class="col-xs-12 row placeholders">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li <?php ControllerDefault::active('adminReservations', '', 'annulees'); ?> ><a href="index.php?controller=adminReservations&action=reservations&mode=annulees" > Annulée <span class="badge">  <?php echo count(ModelReservation::getReservationsAnnulee()) ?> </span></a></li>
            <li <?php ControllerDefault::active('adminReservations', '', 'finis'); ?> ><a href="index.php?controller=adminReservations&action=reservations&mode=finis" > Finie <span class="badge">  <?php echo count(ModelReservation::getReservationsFinis()) ?> </span></a></li>
        </ul>
        <br>
        ...
        elseif(empty($tab_reservations)) {
            ...
            foreach ($tab_reservations as $reservations) {
                ...
                <a href="index.php?controller=adminReservations&action=read&idReservation='.$id.'" class="btn btn-xs btn-primary"><i class="fa fa-eye" aria-hidden="true"></i> Voir</a>
                </td>';
                echo '';
